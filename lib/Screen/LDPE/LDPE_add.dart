...
import 'package:recycle_project/Screen/LDPE/LDPE_added.dart';
import 'package:recycle_project/Screen/Qrscan.dart';
import 'package:uuid/uuid.dart';

class LDPE_addWidget extends StatefulWidget {
  LDPE_addWidget({Key? key}) : super(key: key);

  @override
  _LDPE_addWidgetState createState() => _LDPE_addWidgetState();
}

class _LDPE_addWidgetState extends State<LDPE_addWidget> {
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => LDPE_addedWidget(
                              trash: trash.text,

...
import 'package:recycle_project/Screen/Receipt.dart';
import 'package:uuid/uuid.dart';
import 'package:flutter/material.dart';
import '../Reward.dart';

class PETE_addedWidget extends StatefulWidget {
  const PETE_addedWidget(
      {Key? key,
      required this.trash,
  ...
  @override
  _PETE_addedWidgetState createState() => _PETE_addedWidgetState();
}

class _PETE_addedWidgetState extends State<PETE_addedWidget> {

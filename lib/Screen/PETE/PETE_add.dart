...
import 'PETE_added.dart';

class PETE_addWidget extends StatefulWidget {
  PETE_addWidget({Key? key}) : super(key: key);

  @override
  _PETE_addWidgetState createState() => _PETE_addWidgetState();
}

class _PETE_addWidgetState extends State<PETE_addWidget> {
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PETE_addedWidget(
                              trash: trash.text,
